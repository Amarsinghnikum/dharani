...
<body>
   ...
   <script type="text/javascript">
      function InvestorConnection(id){
        ...
        <main>
            ...
            <!-- hero-area end -->
            <form action="{{url('/saveanswer')}}" method="POST">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-12">
                              <div class="emp-sidebar leftbar">
                                ...
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title borderleft">
                                       <a href="{{url('/investor-connection')}}" class="usermenu-active">
                                        ...
                                        <div class="table-responsive-sm">
                                            ...
                                            @php $i=1; @endphp
                                              ...
                                              <tr>
                                                  <td>{{$i}}</td>
                                                  <td>
                                                    <h5>{{$investorconnection->name}}</h5>
                                                  </td>
                                                  <td>{{$investorconnection->phone}}</td>
                                                  <td>
                                                    <a href="mailto:h@gmail.com" target="_blank">{{$investorconnection->email}}</a></td>
                                                  <td>
                                                     <a href="#" class="btn orangebtn mt-0 px-2 py-2" title="View Chat" data-toggle="collapse" data-target="#chatrow" aria-expanded="true" aria-controls="chatrow">
                                                        <i class="far fa-comment-dots"></i> View</a>
                                                  </td>
                                              </tr>
                                            @foreach($questions as $ques=>$que)
                                            @if($que->question!='')
                                                    ...
                                                    <div class="incoming_msg mb-2">
                                                      <div class="received_msg">
                                                        <div class="received_withd_msg">                                                      
                                                         <p><strong>Q:</strong> {{$que->question}}</p>
                                                           <span class="time_date"> {{$que->created_at}}</span></div>
                                                      </div>
                                                    </div>
                                                    @endif
                                                    @if($que->answer!='')
                                                        <div class="incoming_msg mb-2 ml-3">
                                                            ...
                                                            <div class="received_withd_msg">
                                                              <p><strong>A:</strong> {{$que->answer}}</p>
                                                              <span class="time_date"> {{$que->created_at}}</span></div>
                                                          </div>
                                                        </div>
                                                        @endif
                                                      ...
                                                      <div class="type_msg">
                                                        <div class="input_msg_write">
                                                          <textarea class="write_msg" placeholder="Type a message..." id="answer_{{$investorconnection->id}}"></textarea>
                                                          
                                                          <a onclick="InvestorConnection({{$investorconnection->id}})" class="msg_send_btn" name="submit">
