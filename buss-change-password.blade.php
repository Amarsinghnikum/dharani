   ...
   <a href="#" class="chaticon" title="chat with us">
      <img src="assets/img/chaticon.png" alt="chat-icon">
        ...
        <main>
            ...
            <form method="post" action="{{url('/savebuss-change-password')}}" id="product_forms">
      		@csrf
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-12">
                             <div class="emp-sidebar leftbar">
                                ...
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title borderleft">
                                       <a href="{{url('/buss-change-password')}}" class="usermenu-active"><i class="fas fa-key"></i> Change Password</a>
                                    </h4>
                                  </div>
                                </div>
                                <div class="panel panel-default">
                    ...
                    <div class="col-sm-6">
                        <div class="input-text">
                            <input type="text" id="old_password" autocomplete="old_password" name="old_password" placeholder="Old Password" class="formfld" required>                                       
                        </div>
                        <div><span id="old_password_error"></span></div>

                        <div class="input-text">
                            <input type="text" id="new_password" autocomplete="new_password" name="new_password" placeholder="New Password" class="formfld" required>
                        </div>
                        <div><span id="new_password_error"></span></div>

                        <div class="input-text">
                            <input type="text" id="confirm_password" autocomplete="confirm_password" name="confirm_password" placeholder="Confirm Password" class="formfld" required>
                        </div>
