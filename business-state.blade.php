                            ...
                            <div class="page__title-content text-center mt-80">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Business State</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="row mb-45">
                                        ...
                                        <div class="col-lg-2 mb-10">
                                            <button class="b-btn w-100 btn-c-0">Submit 
                                ...
                                <div class="col-sm-12">
                                    <div class="table-responsive">
                                            <table class="table table-striped table-bordered policytable">
                                                  <thead>
                                                       <th width="80">Sr.No</th>
                                                       <th class="minwid200-mob">Policy State Name</th>
                                                       <th class="minwid200-mob" width="250">Download</th>
                                                  </thead>
                                                  <tbody>
                                                    <tr>
                                                      <td>1.</td>
                                                      <td>Business Teaser/Executive Summary</td>
                                                      <td><a href="#" class="b-btn b-btn-green"><i class="far fa-file-pdf"></i> Download</a></td>
                                                    </tr>
                                                    <tr>
                                                      <td>2.</td>
                                                      <td>Business Teaser/Executive Summary</td>
