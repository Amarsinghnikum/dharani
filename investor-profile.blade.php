   ...
   <a href="#" class="chaticon" title="chat with us">
      <img src="assets/img/chaticon.png" alt="chat-icon">
        ...
        <main>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="page__title-content text-center mt-80">
                                <h2>Invester Panel</h2>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item"><a href="{{url('/index')}}">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Invester Panel</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
            ...
            <!-- hero-area end -->
          <form method="POST" action="{{url('/saveinvestor-profile')}}" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-12">
                             <div class="emp-sidebar leftbar">
                                ...
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title borderleft">
                                       <a href="{{url('/investor-dashboard')}}"><i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard</a>
                                    </h4>
                                  </div>
                                </div>
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title borderleft">
                                       ...
                                       <a href="{{url('/saveinvestor-profile')}}" class="usermenu-active">
                                         <i class="fas fa-coins"></i> Investors Profile</a>
                                    </h4>
                                  </div>
                                </div>
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title borderleft">
                                       <a href="{{url('/business-connection')}}">         
                                         <i class="fas fa-user"></i> Business Connection</a>
                                    </h4>
                                  </div>
                                </div>
                                <div class="panel panel-default">
                                ...
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title borderleft">
                                       <a href="{{url('/investorchange-password')}}"><i class="fas fa-key"></i> Change Password</a>
                                    </h4>
                                  </div>
                                </div>
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title borderleft">
                                       <a href="{{url('/session/removee')}}"><i class="fas fa-sign-out-alt"></i> Logout</a>
                                    </h4>
                                  </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-text">
                                        <label>Full Name <span class="valired">*</span></label>                                       
                                        <input type="text" name="fullname" placeholder="" value="{{$investorprofile!=''?$investorprofile->fullname:''}}" class="formfld" >
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input-text">
                                        <label>Phone Number<span class="valired">*</span></label>
                                        <input type="text" name="phonenumber" placeholder="" value="{{$investorprofile!=''?$investorprofile->phonenumber:''}}" class="formfld">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input-text">
                                        <label>Email Address<span class="valired">*</span></label>
                                        <input type="text" name="email" placeholder="" value="{{$investorprofile!=''?$investorprofile->email:''}}" class="formfld">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input-text">
                                        <label>Company <span class="valired">*</span></label>
                                        <input type="text" name="company" placeholder="" value="{{$investorprofile!=''?$investorprofile->company:''}}" class="formfld">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input-text">
                                        <label>Domains Interested In <span class="valired">*</span></label>
                                        <select class="formfld selectfld" name="domains">
                                             <option>{{$investorprofile!=''?$investorprofile->domains:''}}</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="input-text">
                                        <label>Location Interested In <span class="valired">*</span></label>
                                        <select class="formfld selectfld" name="location">
                                             <option>{{$investorprofile!=''?$investorprofile->location:''}}</option>
                                             <option>India</option>
                                             <option>UK</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="input-text">
                                        <label>Funds (Want to Invest)<span class="valired">*</span></label>
                                        <input type="text" name="funds" placeholder="" value="{{$investorprofile!=''?$investorprofile->funds:''}}" class="formfld">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input-text">
                                        <label>Profile Image<span class="valired">*</span></label>
                                        <input type="file" name="profileimage" placeholder="" value="{{$investorprofile!=''?$investorprofile->profileimage:''}}" class="formfld">
                                        <input type="text" value="{{$investorprofile!=''?$investorprofile->profileimage:''}}">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="input-text">
                                        <label>Previous Investments Details</label>
                                        <textarea name="previousinvestment" placeholder="" class="formfld">
                                        {{$investorprofile!=''?$investorprofile->previousinvestment:''}}
                                        </textarea>                  
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="input-text">
                                        ...
                                        <textarea name="aboutme" placeholder="" class="formfld"> 
                                        {{$investorprofile!=''?$investorprofile->aboutme:''}}
                                        </textarea>                              
                                    </div>
                                </div>
                                <div class="col-sm-6"></div>
                                <div class="col-sm-6">
                                    <button type="submit" name="submit" class="orangebtn" style=" float: right;">Submit</button>
                                </div>
</form>
                                          ...
                                          <table class="table table-striped table-bordered table-hover">
                                            <thead class="thead-dark">
                                              <tr>
                                                  ...
                                                  <th>Email</th>
                                                  <th>Company</th>
                                                  <th>Domains Interested In</th>
                                                  <th>Location Interested In</th>
                                                  <th>Funds (Want to Invest)</th>
