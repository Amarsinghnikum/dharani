                                ...
                                <div class="col-sm-12">
                                   <div class="filtercont">
                                       <div class="row">
                                          ...
                                          <div class="col-sm-4 col-md-5 pr-sm-0">
                                          ...
                                          <div class="col-sm-4 col-md-2">
                                               <button type="submit" class="orangebtn mt-0">Submit</button>
                                          </div>
                                       </div>
                                   </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="job-item mb-30">
                                        <div class="row align-items-center">
                                            <div class="job-wrapper" style="width: 100%;">
                                                    <div class="banck-icon">
                                                        <i class="flaticon-dashboard"></i>
                                                    </div>
                                                    <div class="job-instructor-profile row" style="width: 100%">
                                                        <div class="col-sm-12">
                                                            <h5 class="investorname"><i class="far fa-address-book"></i> Harpreet Singh</h5>
                                                        </div>
                                                        <div class="col-sm-4 col-md-3">
                                                           <div class="job-instructor-img investorimg">
                                                             <img src="assets/img/investor-img.jpg" alt="">
                                                           </div>
                                                        </div>
                                                        <div class="col-sm-8 col-md-9">
                                                        <div class="investordet">  
                                                            <div class="investorbtns">         
                                                                <div class="job-meta mt-15">
                                                                    <a href="tel:" target="_blank"><i class="fas fa-mobile-alt"></i> +91 98562539870</a>
                                                                </div>
                                                                <div class="job-meta mt-15">
                                                                    <a href="mailto:" target="_blank"><i class="far fa-envelope"></i> harpreet@gmail.com</a>
                                                                </div>
                                                                <div class="job-meta mt-15">
                                                                    Want to Invest: <i class="fas fa-rupee-sign"></i> 250542
                                                                </div>
                                                            </div>
                                                            <div class="investordetail">
                                                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>

                                                                <a class="b-btn b-btn-green" href="#" style="float: right;">Contact Me <i class="far fa-arrow-right"></i>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="job-item mb-30">
                                        <div class="row align-items-center">
                                            <div class="job-wrapper" style="width: 100%;">
                                                    ...
                                                    <div class="job-instructor-profile row" style="width: 100%">
                                                        <div class="col-sm-12">
                                                            <h5 class="investorname"><i class="far fa-address-book"></i> Nishant Chabra</h5>
                                                        </div>
                                                        <div class="col-sm-4 col-md-3">
                                                           <div class="job-instructor-img investorimg">
                                                             <img src="assets/img/investor-img.jpg" alt="">
