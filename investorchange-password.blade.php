   ...
   <a href="#" class="chaticon" title="chat with us">
      <img src="assets/img/chaticon.png" alt="chat-icon">
        ...
        <main>
            ...
            <!-- hero-area end -->
            <form method="post" action="{{url('/saveinvestorchange-password')}}" id="product_form">
      		@csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-text">
                                        <input type="text" name="old_password" id="old_password" placeholder="Old Password" class="formfld" required>                                       
                                    </div>
                                    <div><span id="old_password_error"></span></div>

                                    <div class="input-text">
                                        <input type="text" name="new_password" id="new_password" placeholder="New Password" class="formfld" required>
                                    </div>
                                    <div><span id="new_password_error"></span></div>

                                    <div class="input-text">
                                        <input type="text" name="confirm_password" id="confirm_password" placeholder="Confirm Password" class="formfld" required>
                                    </div>
                                    <div><span id="confirm_password_error"></span></div>

                                    <button type="submit" name="submit" class="orangebtn">Change Password</button>
                                    <!-- </form> -->
                                </div>
