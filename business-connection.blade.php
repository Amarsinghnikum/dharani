...
<body>
   ...
   <script type="text/javascript">
      function BusinessConnection(id){
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-12">
                             <div class="emp-sidebar leftbar">
                                ...
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title borderleft">
                                       <a href="{{url('/saveinvestor-profile')}}">
                                ...
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title borderleft">
                                       <a href="{{url('/business-connection')}}" class="usermenu-active">
                                ...
                                <div class="col-sm-12">
                                    <div class="cat-down">
                                        <div class="table-responsive-sm">
                                            ...
                                            @php $i=1; @endphp
                                              <tr>
                                                  <td>{{$businessconnection->id}}</td>
                                                  <td>
                                                    <h5>{{$businessconnection->name}}</h5>
                                                    <div class="gridphone">
                                                        <i class="fas fa-mobile-alt"></i> {{$businessconnection->phone}}
                                                    </div>
                                                    <div class="gridphone">
                                                        <i class="far fa-envelope"></i> <a href="mailto:h@gmail.com" target="_blank">{{$businessconnection->email}}</a>
                                                    </div>
                                                  </td>
                                                @php $i=$i+1; @endphp
                                          
                                                  <td>{{$businesslisting->industries}}</td>
                                                  <td>{{$businesslisting->category}}</td>
                                                  <td>{{$businesslisting->country}}</td>
                                                  <td><i class="fas fa-rupee-sign"></i> {{$businesslisting->fundingneeded}}
                                                      <div class="gridedit">
                                                         
                                                      </div>
                                                  </td>                                                                                                                                      
                                                  <td>
                                                     <a href="{{url('/business_connection')}}" class="btn orangebtn mt-0 px-2 py-2" title="View Chat" data-toggle="collapse" data-target="#chatrow" 
                                                        aria-expanded="true" aria-controls="chatrow">
                                                    <i class="far fa-comment-dots"></i> View</a>
                                                  </td>
                                              </tr>
                                            @foreach($questions as $que=>$ques)
                                            @if($ques->question!='') 
                                            <tr class="collapse show" id="chatrow">
                                              <td colspan="7">
                                                <div class="mesgs">
                                                    ...
                                                    <div class="incoming_msg mb-2">
                                                      <div class="received_msg">
                                                        <div class="received_withd_msg">                                                      
                                                         <p><strong>Q:</strong> {{$ques->question}}</p>
                                                           <span class="time_date"> {{$ques->created_at}}</span></div>
                                                      </div>
                                                    </div>
                                                    @endif
                                                    @if($ques->answer!='')
                                                        <div class="incoming_msg mb-2 ml-3">
                                                            <div class="received_msg ans_msg">
                                                            <div class="received_withd_msg">
                                                              <p><strong>A:</strong> {{$ques->answer}}</p>
                                                              <span class="time_date"> {{$ques->created_at}}</span></div>
                                                          </div>
                                                        </div>
                                                        @endif
                                                      ...
                                                      <div class="type_msg">
                                                        <div class="input_msg_write">
                                                          <textarea class="write_msg" placeholder="Type a message..." id="question_{{$businessconnection->id}}"></textarea>
                                                          <a onclick="BusinessConnection({{$businessconnection->id}})" class="msg_send_btn" name="submit">
