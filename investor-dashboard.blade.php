                                ...
                                <div class="panel panel-default">
                                  <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title borderleft">
                                       <a href="{{url('/investor-dashboard')}}" class="usermenu-active"><i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard</a>
                                    </h4>
                                  </div>
                                </div>
                                <div class="panel panel-default">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="section-title mb-sm-60 mb-20">
                                        <h2>Welcome to Investor Panel</h2>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-7">
                                    <div class="profile-status">
                                        <div>
                                            <img src="assets/img/profile-status.jpg" align="profile status image">
                                        </div>
                                        <div>
                                            <h4>Complete Your Profile</h4>
                                            <a href="{{url('/investor-profile')}}" class="orangebtn">Click Here</a>
                                        </div>
                                    </div>
                                </div>
